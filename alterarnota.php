...
if (isset($_POST['enviar'])):
    ...
    if (mysqli_query($conn, $sql)){
        echo "As Notas foram atualizadas com sucesso!";
        header("location:alterarnota.php");
    }else{
...
?>
         <div class="form-group">
             ...
             <input type="text" name="av1" class="form-control" <?php echo isset($AV1)? "value='$AV1'" : "placeholder='Nota Avaliação 1'"; ?>>         
         </div>
                        
         <div class="form-group">
             <label>Atividade 2</label>
             <input type="text" name="av2" class="form-control" <?php echo isset($AV1)? "value='$AV2'" : "placeholder='Nota Avaliação 2'"; ?>>
         </div>
                        
         <div class="form-group">
             <label>Atividade 3</label>
             <input type="text" name="av3" class="form-control" <?php echo isset($AV1)? "value='$AV3'" : "placeholder='Nota Avaliação 3'"; ?>>
         </div>
