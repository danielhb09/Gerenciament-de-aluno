                ...
                <div class="col-md-12">
                    ...
                    <div class="form-groupp ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="av1" class="form-control" min="0" max="10" />
                            
                        </div>
                        <div class="form-group">
                            <label>Avaliação 2</label>
                           
                            <input type="number" name="av2" class="form-control" min="0" max="10" /> 
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="av3" class="form-control" min="0" max="10" />
